...
st.header('Anuncios Clasificados de Coches')
...
#crear un histograma
         fig = px.histogram(car_data,title='Análisis de Kilometraje',x='odometer')
...
#crear el gráfico
         fig=px.scatter(car_data, title="kilometraje y precio" ,x="odometer", y="price")
